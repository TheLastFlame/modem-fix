...
elif [ "$CODENAME" == "raven" ] || [ "$CODENAME" == "oriole" ] || [ "$CODENAME" == "bluejay" ] && [ "$CFGVER" == "cfgdb-whi-230923-B-10853216" ]; then
    cp -rf "$MODPATH/cfgs/pixel_6/cfgdb-whi-230923-B-10853216/cfg.db" "$MODPATH/system/vendor/firmware/carrierconfig/"
